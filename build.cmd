...
REM ~~~~~~~~~~~~~2025-10-10:
REM ~~~~~~~~~~~~~git -C mesa-%MESA_VERSION% checkout f8729ee92002d74553c1d5938937898a7334b863
REM ~~~~~~~~~~~~~2025-10-11:
REM ~~~~~~~~~~~~~git -C mesa-%MESA_VERSION% checkout bbdd688bc5716d38edc688a0bae644592c33d51e
REM ~~~~~~~~~~~~~2025-10-14:
REM ~~~~~~~~~~~~~-C mesa-%MESA_VERSION% checkout 142079759bec8f63b9d2c3a19e3f874469cbd464
REM ~~~~~~~~~~~~~2025-10-14:
REM ~~~~~~~~~~~~~git -C mesa-%MESA_VERSION% checkout a81f01bc961cae205d98d4e7527c029b81cd17ec
REM ~~~~~~~~~~~~~2025-10-14:
REM ~~~~~~~~~~~~~-C mesa-%MESA_VERSION% checkout 0d8219f36708e1f36c58c3230ae86ba66e5be5a3
REM ~~~~~~~~~~~~~2025-10-14:
REM ~~~~~~~~~~~~~git -C mesa-%MESA_VERSION% checkout f436844f39eaf5271b4b62ae526e4b55c88315c7
REM ~~~~~~~~~~~~~2025-10-14:
REM ~~~~~~~~~~~~~git -C mesa-%MESA_VERSION% checkout 8de89f4ffb19e6f371e68ee64ea66938530109d7
REM ~~~~~~~~~~~~~2025-10-14:
REM ~~~~~~~~~~~~~git -C mesa-%MESA_VERSION% checkout 859505d95abe001993ea77c19188d9b1bf185328
REM ~~~~~~~~~~~~~2025-10-14:
...
REM ~~~~~~~~~~~~~2025-10-14:
REM ~~~~~~~~~~~~~git -C mesa-%MESA_VERSION% checkout 681c734804b1dd251606792be4187942dc9ee180
REM ~~~~~~~~~~~~~2025-10-14:
...
REM ~~~~~~~~~~~~~2025-08-01:
REM ~~~~~~~~~~~~~git -C mesa-%MESA_VERSION% checkout c64c6a0c31f9cb1339bc700d236932171f7444a3
REM ~~~~~~~~~~~~~REM 2025-08-15:
REM ~~~~~~~~~~~~~git -C mesa-%MESA_VERSION% checkout 060a084a1214d0998c2c784b554c3735233adc08

REM 2025-08-21:
git -C mesa-%MESA_VERSION% checkout ecbe35d8788acff8ff8d852a7320d58fbc0aa6c7




REM ----------2025-09-01:
REM ----------git -C mesa-%MESA_VERSION% checkout 564b6fd7f43c4f1b158cb89251d6f523c1acdeca
REM ----------2025-09-15:
REM ----------git -C mesa-%MESA_VERSION% checkout 95579b7af6a38267f8234bbb63580106c6a0eb72
REM ----------2025-10-01:
REM ----------git -C mesa-%MESA_VERSION% checkout 42a78a1aae19f855b049462d7714cd1f07ca12e4
